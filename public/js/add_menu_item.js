...
let addPersonForm = document.getElementById('add-menuitem-form-ajax');
...
addPersonForm.addEventListener("submit", function (e) {
    ...
    let inputLastName = document.getElementById("input-price");
    let inputHomeworld = document.getElementById("input-category");
    ...
    let data = {
        name: firstNameValue,
        price: lastNameValue,
        itemCategory: homeworldValue,
        
    }
    
    // Setup our AJAX request
    var xhttp = new XMLHttpRequest();
    xhttp.open("POST", "/add_menu_item-ajax", true);
